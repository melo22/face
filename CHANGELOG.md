...
- moving face ahoy function to main functions file
...
- removed "Powered by Wordpress & face" from footer, because let's face it: we all delete this anyway.
...
- removed default "face" text in footer if you don't have a menu
...
- added face body class depending on what browser
...
- added post formats to face.php core
...
- fixed error in face.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the face file so it's easier to see what's being
	called.
